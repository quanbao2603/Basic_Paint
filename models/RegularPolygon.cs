...
namespace Painting.models
{
    public class RegularPolygon : Shape
    {
        ...
        public RegularPolygon(Point p1, Point p2, Pen pen, Brush brush, int order, int sides = 5)
    : base(p1, p2, pen, brush, order)
        ...
        private Point[] GetPolygonPoints(Point p1, Point p2, int sides)
        {
            ...
            // Radius based on half of the width/height
            ...
            {
                double angle = i * angleStep - Math.PI / 2; // Rotate so it points upward
